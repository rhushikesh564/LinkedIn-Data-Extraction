...
#os.environ["PROXYCURL_API_KEY"] = os.environ.get("PROXYCURL_API_KEY")
...
#linkedin_data = scrape_linkedin_profile("https://www.linkedin.com/in/niravshah13101976")
...
st.header("Summarize user Linkedin Profile")
st.text_input("provied the linkedin profile ")
...
if submit:
    ...
    st.write(chain.run(information=linkedin_data))